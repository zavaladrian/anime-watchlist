        ...
        <div>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-red-200 outline-none focus:outline-none">
                ...
                >
                  <Form>
                    <div className="relative p-6 flex-auto">
                      <div className="space-y-12 sm:space-y-16 bg-red-200">
                        <div>
                          <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-600">
                            You got a show you want to add to the list? You can
                            add it here to add to your own list!
                          </p>
                          <div className="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                              ...
                              <div className="flex rounded-md shadow-sm bg-red-100 ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md mt-2 sm:col-span-2 sm:mt-0">
                                <Field
                                  type="text"
                                  name="name"
                                  id="name"
                                ...
                                <div className="mt-2 sm:col-span-2 sm:mt-0">
                                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <Field
                                      ...
                                      id="publisher"
                                      autoComplete=""
                                      className="block flex-1 border-0 py-1.5 pl-1 bg-red-100 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                      placeholder="Aniplex"
                                    />
                                  </div>
                                </div>
